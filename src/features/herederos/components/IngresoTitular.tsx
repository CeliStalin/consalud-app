  ...
  const handleFlow = useCallback(async () => {
    ...
    setTimeout(() => {
      ...
      const titularOk =
        titularContext &&
        titularContext.rut &&
        titularContext.rut.replace(/\./g, '').toLowerCase() ===
          rut.replace(/\./g, '').toLowerCase();
      ...
      <ConsaludCore.Card variant="elevated" padding="large">
        ...
        >
          <ConsaludCore.Typography variant="h6" color="#E11D48">
            Ocurrió un error inesperado al consultar el BFF.
            <br />
          ...
          >
            <div style={{ width: '100%', maxWidth: 1000, margin: '0 auto' }}>
              <div style={{ marginBottom: 32 }}>
                ...
                <ConsaludCore.Typography variant="body2" style={{ color: '#656565', fontSize: 15 }}>
