        ...
        {showHelp && onHelpClick && (
          ...
          >
            ...
            >
              ...
              />
              <path
                d="M9.09 9C9.3251 8.33147 9.78915 7.76811 10.4 7.40921C11.0108 7.0503 11.7289 6.91894 12.4272 7.03871C13.1255 7.15849 13.7588 7.52252 14.2151 8.06398C14.6713 8.60543 14.9211 9.30197 14.92 10.02C14.92 12 11.92 13 11.92 13"
                stroke="#00CBBF"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
      ...
      <div
        ...
        onMouseLeave={e => {
          e.currentTarget.style.borderColor =
            fileState.file || fileState.documento ? '#00CBBF' : '#E0E0E0';
          e.currentTarget.style.backgroundColor =
            fileState.file || fileState.documento ? '#F0FDFC' : '#FAFAFA';
        }}
      >
        <input
          type="file"
          ...
          >
            {fileState.file || fileState.documento ? (
              ...
              >
                ...
                />
                <path
                  d="M10.498 10.9434L12.499 8.94336L14.5 10.9434"
                  stroke="#00CBBF"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <div>
            {fileState.error ? (
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                >
                  Tamaño:{' '}
                  {((fileState.file?.size || fileState.documento?.tamaño || 0) / 1024).toFixed(1)}{' '}
                  KB
                  {fileState.documento && (
                    <span>
                      {' '}
                      • Cargado:{' '}
                      {new Date(fileState.documento.fechaCarga).toLocaleDateString('es-CL')}
                    </span>
                  )}
                </p>
              </div>
              ...
              >
                <span style={{ fontWeight: 'bold', color: '#333333' }}>
                  Solo puedes adjuntar documentos
                </span>{' '}
                en formato PDF con un peso máximo de 10MB.
              </p>
            )}
          </div>
        </div>
