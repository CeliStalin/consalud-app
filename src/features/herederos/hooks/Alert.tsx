...
export const UseAlert = () => {
  ...
  const mostrarAlertaHerederoRegistrado = () => {
    Swal.fire({
      ...
      customClass: {
        ...
        // Al hacer clic en "Entendido" no se ejecuta el callback, se queda en la misma pantalla
        // if (_result.isConfirmed && onModificar) {
        //   onModificar();
        // }
      });
  };
